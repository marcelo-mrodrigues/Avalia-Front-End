...
const HeaderDeslogado = () => {
  return (
    <header>
        ...
        <Link href="/usuario/logado" className="bg-[#00ABED] w-[154px] h-[55px] ml-auto mr-14 border border-white rounded-2xl shadow-md text-white text-center text-[30px] font-Questrial">
            Login
        </Link>
        </div>
    </header>
